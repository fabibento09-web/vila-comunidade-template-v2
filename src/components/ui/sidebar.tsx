      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-paper/90 backdrop-blur-xl p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
        ...
        <div
          className={cn(
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-transparent group-data-[side=right]:border-transparent border-r-0 border-l-0',
            className,
          )}
          {...props}
        >
